# Bespoken Contributor Guide

Excited about Bespoken and want to make it better? We’re excited too!

Sign up for the [Bespoken Gitter here](https://gitter.im/bespoken/bst).
...
We welcome any ideas about how to make Bespoken better for your use case. Please include the following information in feature requests:
...
(Adapted from [Apollo contributing guideline](https://github.com/apollographql/apollo-client/blob/master/CONTRIBUTING.md))